...
void Cropper::Callback(const sensor_msgs::PointCloud2& msg) {
  ...
  ros::param::param("crop_min_x", min_x, 0.85);
  ros::param::param("crop_min_y", min_y, -0.45);
  ros::param::param("crop_min_z", min_z, 0.75);
  ros::param::param("crop_max_x", max_x, 1.25);
  ros::param::param("crop_max_y", max_y, 0.45);
  ros::param::param("crop_max_z", max_z, 1.55);
